...
func TestBuildHeader(t *testing.T) {
	...
	expected := []string{"Date(YYYY/MM/DD)", "Time",
		...
		"CW Torq[1] (Dec)", "CW AD[1] (Dec)",
		"CW Torq[2] (Dec)", "CW AD[2] (Dec)",
		"CW Torq[3] (Dec)", "CW AD[3] (Dec)",
		"CW Torq[4] (Dec)", "CW AD[4] (Dec)",
		"CW Torq[5] (Dec)", "CW AD[5] (Dec)",
		"CW Torq[6] (Dec)", "CW AD[6] (Dec)",
		"CW Torq[7] (Dec)", "CW AD[7] (Dec)",
		"CW Torq[8] (Dec)", "CW AD[8] (Dec)",
		"CW Torq[9] (Dec)", "CW AD[9] (Dec)",
		"CW Torq[10] (Dec)", "CW AD[10] (Dec)",
		"CW Torq[11] (Dec)", "CW AD[11] (Dec)",
		"CW Torq[12] (Dec)", "CW AD[12] (Dec)",
		"CCW Torq[1] (Dec)", "CCW AD[1] (Dec)",
		"CCW Torq[2] (Dec)", "CCW AD[2] (Dec)",
		"CCW Torq[3] (Dec)", "CCW AD[3] (Dec)",
		"CCW Torq[4] (Dec)", "CCW AD[4] (Dec)",
		"CCW Torq[5] (Dec)", "CCW AD[5] (Dec)",
		"CCW Torq[6] (Dec)", "CCW AD[6] (Dec)",
		"CCW Torq[7] (Dec)", "CCW AD[7] (Dec)",
		"CCW Torq[8] (Dec)", "CCW AD[8] (Dec)",
		"CCW Torq[9] (Dec)", "CCW AD[9] (Dec)",
		"CCW Torq[10] (Dec)", "CCW AD[10] (Dec)",
		"CCW Torq[11] (Dec)", "CCW AD[11] (Dec)",
		"CCW Torq[12] (Dec)", "CCW AD[12] (Dec)",
	}
